...
set LOG="D:\Facul\2025.2\projetoF_SD"
...
@echo *****Formador de Textos Distribuidos*****
@echo Tamanho da barreira = %BARRIER_SIZE%
@echo Quantidade de palavras no texto = %MIN_WORDS%
@echo.


java -Dlogback.configurationFile=file:%LOG%\logback.xml -cp %CP_ZK% codigos.Main %ZK_ADDR% %BARRIER_SIZE% %MIN_WORDS%